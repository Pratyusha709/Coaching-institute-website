...
## LEARNING OUTCOMES
-Learned how to build a structured website using  basic concepts of web development
-Understood navigation menus and page layout
-Learned how forms validation and css animations work
-Improved frontend design and styling skills
## Project Purpose
-To practice frontend web development concepts
-To create a real-world educational website layout
